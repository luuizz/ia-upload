        ...
        <main className="flex-1 p-6 flex gap-6">
          <div className="flex flex-col flex-1 gap-4">
            <div className="grid grid-rows-2 gap-4 flex-1">
              <Textarea 
                className="resize-none p-4 leadding-relaxed"
                placeholder="Inclua o promot para IA..." />
          ...
          <aside className="w-80 space-y-6">
            <form className="space-y-6">
              <label htmlFor="video"
              className=" transition-all ease delay-75 border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary text-gray-100"
              >
              ...
              <div className="space-y-2">
                <Label htmlFor="transcription_prompt">
                  ...
                  <Textarea id="transcription_prompt" className="h-20 leading-relaxed resize-none mt-5"
            ...
            <div className="space-y-2">
                ...
                <Select>
                  <SelectTrigger>
                    <SelectValue  placeholder="Selecione um promot" />
                  </SelectTrigger>
                  <SelectContent>
